...
var_dump($service->flattenRoutesToArray($result));
file_put_contents(__DIR__ . "/config/router.config.php", "<?php 
/**
* Autogenerated file by flatten-route-service.
*/

return array(
'routes' => " . var_export($service->flattenRoutesToArray($result), true) . ");");
